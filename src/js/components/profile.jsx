...
const Profile = ({ user, handleLogOut, handleAddInput, editedfirstName, editedlastName }) => {
    return (
        ...
        <h2 onClick={ handleAddInput } className="user-name"> { user.firstName + ' ' + user.lastName } </h2>
