...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initStore = __webpack_require__(238);
	...
	var routes = _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/feed', component: (0, _requireAuthentication.requireAuthentication)(_feedContainer2.default) }),
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/create-event', component: (0, _requireAuthentication.requireAuthentication)(_createEventContainer2.default) },
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: (0, _requireAuthentication.requireAuthentication)(_eventDetailsContainer2.default) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createEvent = __webpack_require__(241);
	...
	exports.default = (0, _redux.combineReducers)({
	    auth: _auth2.default,
	    createEvent: _createEvent2.default,
	    user: _user2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createEvent() {
	    ...
	    switch (action.type) {
	        ...
	        case _createEvent.SET_EVENT_DETAILS:
	            return setEventDetails(state, action);

	        case _createEvent.SET_EVENT_WHAT:
	        case _createEvent.SET_EVENT_WHERE:
	            return setEvent(state, action);

	        case _createEvent.SET_EVENT_WHEN:
	            return setEventWhen(state, action);

	        case _createEvent.ADD_INPUT:

	            return addInput(state, action);

	        case _createEvent.REMOVE_INPUT:
	            return removeInput(state, action);

	        case _createEvent.NEW_EVENT:
	...
	function setEventDetails(state, action, key) {
	    ...
	    return _extends({}, state, _defineProperty({}, action.eventType, _extends({}, state.eventDetails, _defineProperty({}, action.inputType, action.data))));
	}

	function setEvent(state, action) {

	    return _extends({}, state, _defineProperty({}, action.eventType, _extends({}, state[action.eventType], _defineProperty({}, action.inputKey, action.data))));
	}
	...
	function addInput(state, action) {
	    ...
	    var initialValue = action.eventType === "eventWhen" ? {} : '';

	    return _extends({}, state, _defineProperty({}, action.eventType, _extends({}, state[action.eventType], _defineProperty({}, action.nextInputKey, initialValue))));
	}

	function removeInput(state, action) {

	    var keys = Object.keys(state[action.eventType]);
	    var newState = {};
	    ...
	    return _extends({}, state, _defineProperty({}, action.eventType, newState));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.newEventRequest = newEventRequest;
	exports.setEventDetails = setEventDetails;
	exports.setEventWhat = setEventWhat;
	exports.setEventWhere = setEventWhere;
	exports.setEventWhen = setEventWhen;
	...
	// create event
	var SET_EVENT_DETAILS = exports.SET_EVENT_DETAILS = "SET_EVENT_DETAILS";
	var SET_EVENT_WHAT = exports.SET_EVENT_WHAT = "SET_EVENT_WHAT";
	var SET_EVENT_WHERE = exports.SET_EVENT_WHERE = "SET_EVENT_WHERE";
	var SET_EVENT_WHEN = exports.SET_EVENT_WHEN = "SET_EVENT_WHEN";
	var ADD_INPUT = exports.ADD_INPUT = "ADD_INPUT";
	var REMOVE_INPUT = exports.REMOVE_INPUT = "REMOVE_INPUT";
	...
	function newEventFailure(error) {
	...
	function newEventRequest(eventData) {

	    return function (dispatch) {

	        dispatch(newEvent());

	        return _axios2.default.post('/new-event', eventData).then(function (response) {
	...
	function setEventDetails(data, inputType) {
	...
	function setEventWhat(data, inputKey) {
	...
	function setEventWhere(data, inputKey) {
	...
	function setEventWhen(data, inputKey, format) {
	...
	function addInput(nextInputKey) {
	    return {
	        type: ADD_INPUT,
	...
	function removeInput(nextInputKey) {
	    return {
	        type: REMOVE_INPUT,
	        nextInputKey: nextInputKey,
	        eventType: "eventWhen"
...
/***/ function(module, exports, __webpack_require__) {
	...
	function auth() {
	    ...
	    switch (action.type) {
	        ...
	        case _createEvent.USER_LOGIN_REQUEST:
	        case _createEvent.USER_LOGIN_SUCCESS:
	        case _createEvent.USER_LOGIN_FAILURE:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.USER_LOGIN_FAILURE = exports.USER_LOGIN_SUCCESS = exports.USER_LOGIN_REQUEST = exports.USER_LOGIN = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    ...
	    //some dispatches
	    return {
	        hydrateState: function hydrateState() {
	            dispatch((0, _user.getUser)());
	        }
	    };
	};

	var FeedContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_feed2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateEventContainer = function (_React$Component) {
	    _inherits(CreateEventContainer, _React$Component);

	    function CreateEventContainer() {
	        _classCallCheck(this, CreateEventContainer);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(CreateEventContainer).apply(this, arguments));
	    }

	    _createClass(CreateEventContainer, [{
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    ...
	    return {
	        handleChange: function handleChange(inputType, event) {

	            dispatch((0, _createEvent.setEventDetails)(event.target.value, inputType));
	        }
	    };
	};

	var EventDetailsContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_eventDetails2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	    var data = state.createEvent.eventWhat;
	    return {
	        eventWhatData: data
	    };
	};
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        handleEventWhat: function handleEventWhat(inputKey, event) {
	            dispatch((0, _createEvent.setEventWhat)(event.target.value, inputKey));
	        },

	        addInput: function addInput(nextInputKey) {
	            dispatch({
	                type: "ADD_INPUT",
	                nextInputKey: nextInputKey,
	                eventType: "eventWhat"
	...
	var EventWhatContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_eventWhat2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventWhat = function EventWhat(_ref) {
	    var eventWhatData = _ref.eventWhatData;
	    var addInput = _ref.addInput;
	    var removeInput = _ref.removeInput;
	    var handleEventWhat = _ref.handleEventWhat;
	    ...
	    var addInputClasses = (0, _classnames2.default)({
	        "hide": inputCount.length >= 3
	    });

	    var removeInputClasses = (0, _classnames2.default)({
	        "hide": inputCount.length === 1
	    });

	    var nextButtonClasses = (0, _classnames2.default)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	    var data = state.createEvent.eventWhere;
	    return {
	        eventWhereData: data
	    };
	};
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        handleEventWhere: function handleEventWhere(inputKey, placeName, placeAddress) {

	            var address = {
	                placeName: placeName,
	                placeAddress: placeAddress
	            };
	            dispatch((0, _createEvent.setEventWhere)(address, inputKey));
	        },
	...
	var EventWhereContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_eventWhere2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventWhere = function EventWhere(_ref) {
	    var eventWhereData = _ref.eventWhereData;
	    var addInput = _ref.addInput;
	    var removeInput = _ref.removeInput;
	    var handleEventWhere = _ref.handleEventWhere;


	    var inputCount = Object.keys(eventWhereData);

	    var inputs = inputCount.map(function (value, i) {

	        var template = eventWhereData[value].placeName + ' ' + eventWhereData[value].placeAddress;
	        var fullAddress = eventWhereData[value].placeName ? template : "";

	        var autocompleteID = 'autocomplete-' + i;
	        return _react2.default.createElement(_autocompleteInput2.default, {
	            handleInput: handleEventWhere.bind(undefined, i),
	            key: i,
	            value: fullAddress,
	            placeholder: 'Where?',
	            id: autocompleteID
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutocompleteInput = function (_React$Component) {
	    ...
	    function AutocompleteInput() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AutocompleteInput).apply(this, arguments));
	    }
	    ...
	    _createClass(AutocompleteInput, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var inputDOMElement = document.getElementById(this.props.id);
	            ...
	            var autocomplete = new google.maps.places.Autocomplete(inputDOMElement, options);

	            autocomplete.addListener('place_changed', function () {

	                var result = autocomplete.getPlace();

	                _this2.props.handleInput(result.name, result.formatted_address);
	            });
	        }
	    }, {
	        key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	    ...
	    var data = state.createEvent.eventWhen;
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        ...
	        handleDate: function handleDate(inputKey, event) {

	            dispatch((0, _createEvent.setEventWhen)(event.target.value, inputKey, "date"));
	        },

	        handleTime: function handleTime(inputKey, event) {

	            dispatch((0, _createEvent.setEventWhen)(event.target.value, inputKey, "time"));
	        },

	        addInput: function addInput(nextInputKey) {
	            dispatch((0, _createEvent.addInput)(nextInputKey));
	        },

	        removeInput: function removeInput() {
	            dispatch((0, _createEvent.removeInput)(nextInputKey));
	        }
	    };
	};

	var EventWhenContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_eventWhen2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventWhen = function EventWhen(_ref) {
	    var eventWhenData = _ref.eventWhenData;
	    var addInput = _ref.addInput;
	    var removeInput = _ref.removeInput;
	    var handleDate = _ref.handleDate;
	    var handleTime = _ref.handleTime;


	    var inputCount = Object.keys(eventWhenData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    ...
	    return {
	        saveEvent: function saveEvent(data) {
	            ...
	            dispatch((0, _createEvent.newEventRequest)(data));
	        },
	...
	var EventConfirmContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_eventConfirm2.default);
